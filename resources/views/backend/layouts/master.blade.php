...
<body>
    ...
    <script>
        ...
        var exampleModal = document.getElementById('myModal')
            ...
            var modalBodyInput = exampleModal.querySelector('#ship_order_no')

            modalBodyInput.value = recipient
        })
        
        function saveShipRokcketNumber() {
            var ship_order_no = $('#ship_order_no').val();
            var shipRokcket_no = $('#shipRokcket_no').val();
            console.log(ship_order_no + shipRokcket_no);

            var token="{{ csrf_token() }}";
            $.post("{{ route('admin.add_shipRokcket_no') }}", {
                ship_order_no:ship_order_no, shipRokcket_no:shipRokcket_no, _token:token
            }, function(data) {
